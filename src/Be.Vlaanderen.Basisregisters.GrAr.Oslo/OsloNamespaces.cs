...
public static class OsloNamespaces
{
    ...
    public static readonly OsloNamespace GebouwGeometrieMethode = new OsloNamespace($"{OsloNamespacePrefix}/concept/2Dgeometriemethode");
    ...
    public static readonly OsloNamespace GebouweenheidGeometrieMethode = new OsloNamespace(OsloNamespacePrefix + "/concept/geometriemethode");
