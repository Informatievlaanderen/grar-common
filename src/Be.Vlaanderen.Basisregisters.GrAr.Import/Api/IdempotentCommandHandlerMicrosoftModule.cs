namespace Be.Vlaanderen.Basisregisters.GrAr.Import.Api
{
    ...
    public class IdempotentCommandHandlerMicrosoftModule
    {
        ...
        public IdempotentCommandHandlerMicrosoftModule(IServiceProvider serviceProvider)
        {
        ...
        {
            using var c = ServiceProvider.CreateScope();

            // GENERIC
            var concurrentUnitOfWork = c.ServiceProvider.GetRequiredService<ConcurrentUnitOfWork>();
            var getStreamStore = c.ServiceProvider.GetRequiredService<Func<IStreamStore>>();
            var eventMapping = c.ServiceProvider.GetRequiredService<EventMapping>();
            var eventSerializer = c.ServiceProvider.GetRequiredService<EventSerializer>();
            var context = c.ServiceProvider.GetRequiredService<IdempotencyContext>();
            ...
            try
            {
                ...
                var processor = c.ServiceProvider.GetRequiredService<IIdempotentCommandHandlerModuleProcessor>();
